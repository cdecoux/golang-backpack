...
type DemoResponse struct {
	...
	RandomNumber int64                  `protobuf:"varint,2,opt,name=random_number,json=randomNumber,proto3" json:"random_number,omitempty"`
}
...
func (x *DemoResponse) GetTime() *timestamppb.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *DemoResponse) GetRandomNumber() int64 {
	if x != nil {
...
var file_demo_proto_rawDesc = []byte{
	...
	,
...
var file_demo_proto_depIdxs = []int32{
	2, // 0: demo.DemoResponse.time:type_name -> google.protobuf.Timestamp
	0, // 1: demo.DemoServer.Demo:input_type -> demo.DemoRequest
	1, // 2: demo.DemoServer.Demo:output_type -> demo.DemoResponse
...
type DemoServerClient interface {
	Demo(ctx context.Context, opts ...grpc.CallOption) (DemoServer_DemoClient, error)
}
...
func NewDemoServerClient(cc grpc.ClientConnInterface) DemoServerClient {
	return &demoServerClient{cc}
}

func (c *demoServerClient) Demo(ctx context.Context, opts ...grpc.CallOption) (DemoServer_DemoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DemoServer_serviceDesc.Streams[0], "/demo.DemoServer/Demo", opts...)
	if err != nil {
		return nil, err
	}
	x := &demoServerDemoClient{stream}
	return x, nil
}

type DemoServer_DemoClient interface {
	Send(*DemoRequest) error
	Recv() (*DemoResponse, error)
	grpc.ClientStream
}

type demoServerDemoClient struct {
	grpc.ClientStream
}

func (x *demoServerDemoClient) Send(m *DemoRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *demoServerDemoClient) Recv() (*DemoResponse, error) {
	m := new(DemoResponse)
...
type DemoServerServer interface {
	Demo(DemoServer_DemoServer) error
}
...
func (*UnimplementedDemoServerServer) Demo(DemoServer_DemoServer) error {
	return status.Errorf(codes.Unimplemented, "method Demo not implemented")
}
...
func _DemoServer_Demo_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DemoServerServer).Demo(&demoServerDemoServer{stream})
}

type DemoServer_DemoServer interface {
	Send(*DemoResponse) error
	Recv() (*DemoRequest, error)
	grpc.ServerStream
}

type demoServerDemoServer struct {
	grpc.ServerStream
}

func (x *demoServerDemoServer) Send(m *DemoResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *demoServerDemoServer) Recv() (*DemoRequest, error) {
	m := new(DemoRequest)
...
var _DemoServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "demo.DemoServer",
	HandlerType: (*DemoServerServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Demo",
			Handler:       _DemoServer_Demo_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
